...
- Android：準備中
- Windows：[Microsoft Storeからダウンロード](https://apps.microsoft.com/detail/9N3VN7TLM99W)
...
このリポジトリに含まれるYuraive独自のソースコード、ドキュメント、画像、アイコン、その他の素材は、個別に異なるライセンス表示があるものを除き、[MIT License](./LICENSE)の下で利用できます。第三者由来の成果物には、それぞれのライセンスが適用されます。
