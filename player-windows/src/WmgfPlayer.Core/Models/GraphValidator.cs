...
public static class GraphValidator
{
    ...
    public static IReadOnlyList<ValidationIssue> Validate(WmgGraph graph) => ValidateJson(WmgJson.Serialize(graph));

    public static HashSet<string> AllAssetPaths(WmgGraph graph)
    {
