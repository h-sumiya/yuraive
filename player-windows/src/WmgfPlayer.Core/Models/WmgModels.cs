...
public sealed record WmgGraph
{
    public int Version { get; init; }
    public WmgMetadata? Metadata { get; init; }
    public Dictionary<string, WmgNode> Nodes { get; init; } = [];
    public Dictionary<string, WmgButton> Buttons { get; init; } = [];
...
public sealed record WmgMetadata
{
...
public sealed record MediaCandidate
{
    ...
    public required WmgMediaSource Source { get; init; }
}

public sealed record WmgMediaSource
{
    public required string Type { get; init; }
...
public sealed record WmgButton
{
