...
public sealed class PlaybackStatsEvaluator
{
    ...
    public async Task<PlaybackStatsData> EvaluateAsync(GraphRef reference, PlaybackUiState playback, CancellationToken cancellationToken = default)
    {
        ...
        var graphSignature = Signature(WmgJson.Serialize(graph));
        ...
        var historySignature = Signature(WmgJson.Serialize(history));
        ...
        string evaluatedAt)
    {
        ...
        var result = new JsonObject
        {
            ...
            ["history"] = JsonSerializer.SerializeToNode(history, WmgJson.Options),
            ["current"] = current,
            ...
            ["session"] = new JsonObject
            {
                ...
                ["entries"] = JsonSerializer.SerializeToNode(session.Entries, WmgJson.Options),
            },
        ...
        return JsonSerializer.SerializeToElement(result, WmgJson.Options);
    }
