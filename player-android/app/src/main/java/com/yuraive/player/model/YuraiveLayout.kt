...
data class YuraiveLayoutIssue(val severity: ValidationIssue.Severity, val message: String)

object YuraiveLayout {
    const val FILE_EXTENSION = ".yuraive-layout.html"
    ...
    fun validate(source: String): List<YuraiveLayoutIssue> {
